        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2"><Mail size={16} className="text-walmart-blue" /> support@walmart-clone.com</li>
              <li className="flex items-center gap-2"><Phone size={16} className="text-walmart-blue" /> +91 1800-123-4567</li>
              <li className="flex items-start gap-2"><MapPin size={16} className="text-walmart-blue mt-1" /> 123 Commerce Street, Bengaluru, India</li>
            </ul>
          </div>
        </div>
